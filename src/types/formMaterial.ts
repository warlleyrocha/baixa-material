...
export const formSchema = z.object({
  officer: z.object({
    ...
    secondRegistration: z.string().max(10, 'Matrícula deve ter no máximo 10 caracteres').optional(),
    ...
    number: z.string().max(5, 'Número da rua deve ter no máximo 5 caracteres').optional(),
